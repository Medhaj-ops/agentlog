...
class TracedStream:
    """Proxy wrapper around openai.Stream that accumulates chunks for tracing.

    Chunks are yielded to the caller unchanged; the span passed in is opened
    by the caller and owned (closed) by this proxy once the stream ends.
    """
...
class TracedAsyncStream:
    """Proxy wrapper around openai.AsyncStream that accumulates chunks for tracing."""
